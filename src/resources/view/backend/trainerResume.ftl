    	...
    	<div class="pxshi_gl_l left">
          ...
          <div class="lanmu">
          	<ul>
                ...
                <li><div class="wsjl cn"><a href="培训师—完善简历.html">完善简历</a></div></li>
...
离异</td>
      ...
      <tr>
        <td><font color="#CCCCCC">请上传宽度为180px,高度为150px,格式：jpg,gif, 大小&lt;500kb的图片</font></td>
                    	...
                    	<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
                    	  ...
                    	  <tr>
                    	    <td height="40" align="right" valign="middle"><font color="#ff0000">*</font> 擅长形式：</td>
                    	    <td><select name="select" id="select">
                    	       <option value="请选择擅长形式">请选择擅长形式</option>
                    	    ...
                    	    <td align="right" valign="middle"><font color="#ff0000">*</font> 培训领域：</td>
                    	    <td><select name="select5" id="select5">
                    	      <option value="请选择培训领域">请选择培训领域</option>
	...
	<option value="9">博士</option>
                        ...
                        <tr>
                    	    <td height="40" align="right" valign="middle"><font color="#ff0000">*</font> 培训经验：</td>
                    	    <td><select name="select" id="select">
                    	      <option value="请选择培训经验">请选择培训经验</option>
                               <option value="5年内">5年内</option>
                              <option value="5-10年">5-10年</option>
                              <option value="10-15年">10-15年</option>
                    	      <option value="15-20年">15-20年</option>
                    	    ...
                    	    <td align="right" valign="middle"><font color="#ff0000">*</font> 地 址：</td>
...
RMB</td>
  ...
  <tr>
    ...
    <td height="40" colspan="4" align="left" valign="middle"><table width="90%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="11%"><font color="#ff0000">*</font>培训经历：</td>
    <td width="89%"><textarea style="width:600px;" name="textarea2" id="textarea2" cols="45" rows="5"></textarea></td>
  </tr>
</table></td>
    </tr>
