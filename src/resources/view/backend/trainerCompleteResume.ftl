			  ...
			  <tr>
			    <td colspan="2"width="420" align="left" valign="top"><table width="400" border="0" cellspacing="0" cellpadding="0">
			      <tr>
			        ...
			        <input type="text" name="trainer.userCenter.name" id="trainer.userCenter.name" value="${trainer.userCenter.name!}" />
					<#else> 
					<input type="text" name="trainer.userCenter.name" id="trainer.userCenter.name"  value="" />
					</#if></td>
								      </tr>
			      <tr>
			        ...
			        <input type="date" name="trainer.userCenter.birthday" id="trainer.userCenter.birthday" value="${trainer.userCenter.birthday!}" />
			        <#else>
			        <input type="date" name="trainer.userCenter.birthday" id="trainer.userCenter.birthday" value="" />
			     	</#if>
			      </td>
			      </tr>
			      <tr>
        	...
        	<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
        	   ...
        	   <#if trainer??  && trainer.education.name() = 'JUNIORHIGHSCHOOL'>
        	    ...
        	    <input type="tel" name="trainer.userCenter.mobile" id="trainer.userCenter.mobile" value="${trainer.userCenter.mobile!}" />
        	    <#else>
        	    <input type="tel" name="trainer.userCenter.mobile" id="trainer.userCenter.mobile" value="" />
        	    </#if>
        	    </td>
      	    </tr>
      	  </table>
...
function checkform(){
	...
	alert(name+education+brithday+marryStatus+mobile+intro);
	return true;
}
