         ...
         <table bgcolor="#dedede" border="0" cellpadding="4" cellspacing="1" align="center" width="860">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center" valign="middle" bgcolor="#ffffff"  class="caozuo"><a href="/website/trainerEssayDetail?trainerEssay.id=${t.id!}" target="_blank">查看</a>&nbsp;&nbsp;  <a href="/website/artticleManage/essayDelete?trainerEssay.id=${t.id!}">删除</a></td>
                      </tr>
                     </#if>
                      </#list>
                      </#if>
