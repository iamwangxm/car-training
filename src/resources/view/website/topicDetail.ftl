            ...
            <div class="wdwd">
                ...
                <div class="wdwd_box">
                	<ul>
                        ...
                        <li><a href="#">轻资产战略——中小银行快速成</a></li>
                        <li><a href="#">好广告的两种表现形式</a></li>
                        <li><a href="#">新员工入职培训的内容和方案</a></li>
                        <li><a href="#">企业机制和管理层能力</a></li>
                        <li><a href="#">轻资产战略——中小银行快</a></li>
                        <li><a href="#">好广告的两种表现形式</a></li>
                    </ul>
                </div>
            </div>
