      ...
      <option value="浙江省">浙江省</option>
        ...
        <div class="pxgs">
        	<div class="pxgs_l left">
            	...
            	<#if jobsStoreList?? && jobsStoreList.result?? && jobsStoreList.result?size gt 0>
            	<div class="fypage" >
            	...
            	<#if pageNo gt 1>
            	<a data-class="p1" href="/website/recruit/?companyType=STORE&pageNo=${pageNo-1}">上一页</a>
            	<#else>
            	...
            	<span>${t!}</span>
            	<#else>
            	<a href="/website/recruit/?companyType=STORE&pageNo=${t!}">${t!}</a>
            	</#if>
            	<#if t = jobsStoreList.totalPage>
            	<#break>
            	</#if>
            	</#list>
            	...
            	<#if (jobsStoreList.totalPage - pageNo) gt 0>
            	<a data-class="n1" href="/website/recruit/?companyType=STORE&pageNo=${pageNo+1}">下一页</a>
            	<#else>
            	<span data-class="n1" class="">下一页</span>
            	</#if>
            	<#if (jobsStoreList.totalPage - ((pageNo/5)?ceiling * 5)) gt 4>
            	...
            	<#list 1..jobsStoreList.totalPage as t>
            	<#if t = pageNo>
